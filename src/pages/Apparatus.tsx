    ...
    <div className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-8 font-accent">
            Аппарат Jungebad
          </h1>
          ...
          <Card className="p-8 shadow-soft mb-8">
            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              ...
              <p>
                ...
                глубоких слоев и обеспечивая поступление необходимых активных ингредиентов в кровоток. Исследования показали, что это самый быстрый метод доставки полезных веществ масла в кровоток без нарушения кожного покрова, в течении 20 минут частицы масла впитываются через кожу и далее участвуют в обмене веществ
              </p>
            </div>
          </Card>
        </div>
