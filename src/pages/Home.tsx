...
import heroImage from "@/assets/oil-dispersion-intro.webp";
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="space-y-8 text-lg text-muted-foreground leading-relaxed">
            ...
            <p>
              Масляно-дисперсионная ванна оказывает глубокое воздействие на внутреннее тепло человека, укрепляет жизненный тонус. Масло, распылённое на мельчайшие капельки, обволакивая всё тело оказывает терапевтическое действие, стабилизирует иммунную систему, регулирует температуру и тепло тела.
            </p>

            <p className="text-primary">
              Масло – концентрированное тепло солнца и растения. Подарок организму человека
            </p>
          </div>
